                  ...
                  <ul className="divide-y divide-slate-100">
                    {items.map((item) => (
                      <li key={item.id} className="py-6 flex">
                        <div className="flex-shrink-0 w-20 h-20 border border-slate-100 rounded-xl overflow-hidden bg-slate-50">
                          <img src={item.images[0]} alt={item.name} className="w-full h-full object-center object-contain" />
                        </div>
